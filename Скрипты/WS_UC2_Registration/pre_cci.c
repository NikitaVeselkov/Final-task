# 1 "c:\\users\\nikitka\\documents\\vugen\\scripts\\ws_uc2_registration\\\\combined_WS_UC2_Registration.c"
...
# 1 "c:\\users\\nikitka\\documents\\vugen\\scripts\\ws_uc2_registration\\\\combined_WS_UC2_Registration.c" 2
...
Action()
{
	...
	lr_end_transaction("GoToCtreateAccount", 2);
   ...
   web_reg_save_param("Authorization",
	...
	web_url("{userID}", 
		...
		"Mode=HTML", 
		"LAST");
lr_end_transaction("CreateAccount", 2);
		
lr_end_transaction("UC_2_Registration", 2);
