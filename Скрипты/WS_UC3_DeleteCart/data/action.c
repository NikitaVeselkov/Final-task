Action()
{
	...
	web_custom_request("401866217_2", 
		...
		"Snapshot=t10.inf", 
		"Mode=HTML", 
		"Body=[{\"hexColor\":\"55CDD5\",\"productId\":25,\"quantity\":1},{\"hexColor\":\"414141\",\"productId\":18,\"quantity\":1}]", 
		LAST);
	...
	web_custom_request("55CDD5", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/carts/401866217/product/25/color/55CDD5", 
		"Method=DELETE", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
